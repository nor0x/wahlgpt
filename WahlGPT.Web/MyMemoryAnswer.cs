...
public class MyMemoryAnswer
{
	...
	public MyMemoryAnswer FromJson(string json)
	{
		return JsonSerializer.Deserialize<MyMemoryAnswer>(json, s_caseInsensitiveJsonOptions)
			   ?? new MyMemoryAnswer();
	}
